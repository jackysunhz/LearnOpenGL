...
int main()
{
    ...
    // -------------------------
    Shader backpackShader("../shaders/backpack.vs", "../shaders/backpack.fs");
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        // Render the cubes and plane
        fbShader.use();
        fbShader.setMat4("projection", projection);
        fbShader.setMat4("view", view);
        // cubes
        glBindVertexArray(cubeVAO);
        ...
        fbShader.setMat4("model", glm::mat4(1.0f));
        ...
        screenShader.use();
        screenShader.setInt("width", SCR_WIDTH);
        screenShader.setInt("height", SCR_HEIGHT);
        glBindVertexArray(quadVAO);
        glActiveTexture(GL_TEXTURE0);
